...
public interface IBackgroundJobService
{
    ...
    string MakeJobId<T>(string clusterName, params object?[] args);

    void ScheduleOrRemove<T>(Expression<Func<T, Task>> methodCall,
                             string cronExpression,
                             bool enabled,
                             string clusterName,
                             params object?[] args);

    void RemoveIfExists<T>(string clusterName, params object?[] args);
