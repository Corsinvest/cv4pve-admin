...
- <span class="ee"></span> :material-bell-plus:{ .lg .middle } **140+ Channels**
...
??? note settings "Show SMTP configuration fields"
...
??? note settings "Show WebHook configuration fields"
...
??? note examples "Show WebHook integration examples (Telegram / Teams / Slack)"
