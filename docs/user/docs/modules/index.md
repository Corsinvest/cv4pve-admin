...
### Application
- **[Command Palette](command-palette.md)** - Quick access to commands and navigation (Ctrl+K / Cmd+K)

### Protection
- **[AutoSnap](autosnap.md)** - Automated snapshot scheduling and management
- **[NodeProtect](node-protect.md)** - Automated node configuration backup and restore
- **[UPS Monitor](ups-monitor.md)** <span class="ee"></span> - UPS monitoring with automated shutdown and power alerts

### Health
- **[Backup Analytics](backup-analytics.md)** - Backup job analysis and trend insights
...
### Automation
- **[Resource Scheduler (DRS)](drs.md)** <span class="ee"></span> - Intelligent VM load balancing and resource scheduling
- **[Workflow](workflow.md)** <span class="ee"></span> - Visual workflow designer for event-driven automation
...
### Management
- **[Portal](portal.md)** <span class="ee"></span> - Multi-tenant MSP portal with role-based access control (RBAC)
